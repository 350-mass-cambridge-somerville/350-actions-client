		...
		<div>
			<Paper className={classes.contentMain}>
				<div>
					{props.actionCard && (
						<MainContentHeader
							mainTitle={`Action Card ${props.actionCard.number}`}
							date={props.actionCard.date}
						/>
					)}
					<Grid container direction="column" alignItems="stretch">
						<Grid item>{generateSurveyForm()}</Grid>
						<Grid item>
							{props.actionCard && (
								<ActionCheckListDisplay
									actions={props.actionCard.actions}
